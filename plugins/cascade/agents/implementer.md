...
**Federate mechanical work.** Delegate builds, test suites, linters, and long-running or verbose commands to the `cascade:mechanic` agent. Reserve direct shell use for trivial one-liners where a round trip is not worth it.
