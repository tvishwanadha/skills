...
name: skills-guide
description: >-
  Skill authoring conventions and best practices. Consult when creating or
  modifying SKILL.md files, reviewing skill quality, or understanding
  frontmatter fields and content guidelines.
